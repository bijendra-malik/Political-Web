...
export interface StrokeTextProps {
  ...
  reverse?: boolean;
  /** When true, the SVG height is driven by CSS so it scales down on small screens. */
  responsive?: boolean;
  className?: string;
  style?: CSSProperties;
}
...
const StrokeText = ({
  ...
  return (
    <span
      ...
      } ${responsive ? "stroke-text-responsive" : ""} ${className}`.trim()}
      style={style}
      role="img"
    ...
    >
      <svg
        ...
        style={responsive ? undefined : { height: `${Math.round(fontSize * 1.3)}px` }}
        viewBox={viewBox}
