"use client";
                [
                  { name: "Instagram", href: "https://www.instagram.com/mrbijendramalik/", p: "M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm0 2a3 3 0 00-3 3v10a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H7zm5 3.5A4.5 4.5 0 1112 16.5 4.5 4.5 0 0112 7.5zm0 2A2.5 2.5 0 1012 14.5 2.5 2.5 0 0012 9.5zM17.5 6a1.25 1.25 0 110 2.5 1.25 1.25 0 010-2.5z" },
                  { name: "Facebook", href: "https://www.facebook.com/TeamBijendraMalik/", p: "M14 8h3V4h-3a5 5 0 00-5 5v3H6v4h3v8h4v-8h3l1-4h-4V9a1 1 0 011-1z" },
                  { name: "X", href: "https://twitter.com/MrBijendraMalik", p: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
                  { name: "YouTube", href: "https://www.youtube.com/@MrBijendraMalik", p: "M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 11.75a29 29 0 00.46 5.33A2.78 2.78 0 003.4 19.1c1.72.46 8.6.46 8.6-.46a2.78 2.78 0 001.94-2 29 29 0 00.46-5.25 29 29 0 00-.46-5.43zM9.75 15.02V8.48l5.75 3.27-5.75 3.27z" },
  useEffect(() => {
  ...
  return (
    <section id="contact" className="py-20 lg:py-28 bg-gradient-to-br from-navy via-navy-light to-royal relative overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-saffron/5 rounded-full blur-3xl" />
                  ...
                  { name: "Facebook", href: "https://www.facebook.com/TeamBijendraMalik/", p: "M14 8h3V4h-3a5 5 0 00-5 5v3H6v4h3v8h4v-8h3l1-4h-4V9a1 1 0 011-1z" },
                  { name: "X", href: "https://twitter.com/MrBijendraMalik", p: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
                  { name: "YouTube", href: "https://www.youtube.com/@MrBijendraMalik", p: "M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 11.75a29 29 0 00.46 5.33A2.78 2.78 0 003.4 19.1c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 001.94-2 29 29 0 00.46-5.25 29 29 0 00-.46-5.43zM9.75 15.02V8.48l5.75 3.27-5.75 3.27z" },
